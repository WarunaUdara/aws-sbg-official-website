...
export const MOCK_TEAM: TeamMember[] = [
  {
    ...
    bio: 'Leading the AWS Student Builder Group at USJ. Spearheading strategic cloud community initiatives, builder programs, industry partnerships, and student developer enablement across the university.',
  ...
  },
  {
    ...
    bio: 'Co-directing operational planning, student builder onboarding pipelines, and resource coordination to power guild activities across campus.',
    certifications: ['AWS Cloud Practitioner'],
    linkedin: 'https://linkedin.com',
  },
]
